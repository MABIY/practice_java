...
public class LazyLists {
    ...
    public static void main(String[] args) {
        ...
        int prime_five = primes(numbers).tail().tail().tail().head();
        int prime_five1 = primes(numbers).tail().tail().tail().tail().head();
        System.out.println(prime_two + " " + prime_three + " " + prime_five + " " + prime_five1);
